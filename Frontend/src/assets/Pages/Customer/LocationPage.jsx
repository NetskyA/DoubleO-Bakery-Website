            ...
            {loading ? (
                <div className="flex items-center justify-center h-screen">
                    <div className="flex-row items-center justify-center">
                        <h1 className="animate-typing2 font-['Open_Sans'] p-4 overflow-hidden text-3xl lg:text-5xl text-gray-500 text-center" style={{ width: 'fit-content' }}>
                            Mencari Lokasi Anda
                        </h1>
                        <p className="text-lg text-center items-center text-gray-700 pt-5">Kami sedang mencari toko terdekat dari lokasi Anda..</p>

                    </div>
                </div>
            ) : (
                <section id="home" className="pt-8 pb-12 dark:bg-dark m-2 ml-2 flex bg-gradient-to-b from-white to-sixth" data-aos="fade-up"
                    data-aos-duration="3000">
                    <div className="container w-full flex items-center mx-auto justify-center">
                        <div className="flex flex-col w-full items-center">
                            <h1 className="text-3xl font-bold text-blue-950">Lokasi Toko</h1>
                            <div className="w-32 h-1 mt-10 bg-gray-500 rounded-full mx-auto my-4"></div>
                            <p className="text-lg w-full p-1 text-center items-center text-gray-700 pt-5">Di setiap tahap, kami berusaha memberikan yang terbaik untuk anda</p>
                                                    ...
                                                    <div className="flex">
                                                        <div className="w-full p-4">
                                                            ...
                                                            <button className="bg-primary ms-2 float-end text-white hover:bg-slate-100 hover:text-primary py-2 px-4 rounded shadow-lg hover:shadow-xl font-bold transition-colors duration-500">
                                                                <a href={`https://wa.me/${outlet.phone.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer">Order Now</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
