                ...
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="number">
                            <p>
                                Driyorejo: <a href="https://wa.me/6281393552600" target="_blank" rel="noopener noreferrer">081393552600</a>
                            </p>
                            <p>
                                Kebraon: <a href="https://wa.me/6282331423600" target="_blank" rel="noopener noreferrer">082331423600</a>
                            </p>
                            <p>
                                Mulyosari: <a href="https://wa.me/6282331423900" target="_blank" rel="noopener noreferrer">082331423900</a>
                            </p>
                            <p>
                                Magetan: <a href="https://wa.me/6282226674600" target="_blank" rel="noopener noreferrer">082226674600</a>
                            </p>
                            <p>
                                Jember: <a href="https://wa.me/0000000000" target="_blank" rel="noopener noreferrer">0000000000</a>
                            </p>
                        </div>
                        <div className="flex">
                        ...
                        <div className="flex cursor-pointer">
                            ...
                            <a onClick={() => navigate("/order/page/doubleo/outlet")} target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
                                Temukan Outlet Kami! 📍
                            </a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center mt-1 space-x-3">
                            <a href="https://www.instagram.com/doubleobakery?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
